...
The player's own pitch-by-pitch video review -- Rapsodo numbers
side-by-side with video, for their own Pitcher-Specific pitches only.
Read-only: uploading video stays staff-only (Pitch Video Review page).
"""
...
from models import Player, User, AssessmentCategory, Assessment, AssessmentResult
