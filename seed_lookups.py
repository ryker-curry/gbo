...
def seed_roles(session):
    ...
    roles = [
        ...
        Role(role_name="Athletic Trainer", description="Assessments, sessions, and IDP progress notes -- edit rights.",
             can_edit_assessments=True, can_edit_idp=True, can_edit_sessions=True, can_view_all_players=True),
        Role(role_name="Sports Scientist", description="All player data (assessments, sessions, IDP) -- read-only.",
             can_edit_assessments=False, can_edit_idp=False, can_edit_sessions=False, can_view_all_players=True),
...
MOBILITY_ROM_TESTS = [
    ...
    ("Shoulder: Throwing Arm External Rotation", "°"), ("Shoulder: Throwing Arm Internal Rotation", "°"),
    ("Shoulder: Non-Throwing Arm External Rotation", "°"), ("Shoulder: Non-Throwing Arm Internal Rotation", "°"),
    ("Shoulder: Throwing Arm Total Arc", "°"), ("Shoulder: Non-Throwing Arm Total Arc", "°"),
    ("Shoulder: GIRD", "°"), ("Shoulder: Flexion", "°"), ("Shoulder: Extension", "°"),
    ...
    ("Hip: Stride Leg Internal Rotation", "°"), ("Hip: Stride Leg External Rotation", "°"),
    ("Hip: Drive Leg Abduction", "°"), ("Hip: Stride Leg Abduction", "°"),
    ("Hip: Drive Leg Adduction", "°"), ("Hip: Stride Leg Adduction", "°"),
