...
def player_game_stats_server(input, output, session, app_state):
    ...
    def body():
        ...
        try:
            ...
            extra_outs = get_runner_event_outs(db, my_player.player_id, season_choice)
            ...
            if my_player.is_pitcher:
                ...
                if not pitching_pitches:
                    ...
                    pl = compute_pitching_line(pitching_pitches, extra_earned_runs=extra_earned_runs, extra_outs=extra_outs)
