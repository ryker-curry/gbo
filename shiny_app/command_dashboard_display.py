...
def register_command_dashboard(input, output, session, key_prefix, get_target):
    ...
    def _results():
        ...
        # out why they miss where they miss ... if i am trying to go
        # down and away do i always miss arm side") -- no inches, just
        # which way each pitch missed and what it was called, so a
        # pattern by call is scannable at a glance.
